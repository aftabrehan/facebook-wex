      ...
      <div className="flex flex-col flex-grow h-full items-center justify-center gap-3">
        ...
        <div className="flex flex-col w-full items-center justify-center gap-3">
          <button
            ...
            className="flex items-center justify-center w-full max-w-[320px] gap-2 cursor-pointer px-6 py-3 bg-blue-500 rounded-xl text-white shadow-md hover:shadow hover:opacity-90 transition-all"
          >
            <svg
              width="24"
              height="24"
          ...
          <button
            ...
            className="flex items-center justify-center w-full max-w-[320px] gap-2 cursor-pointer px-6 py-3 rounded-xl text-black text-opacity-50 shadow-md hover:shadow hover:opacity-90 transition-all"
          >
            <svg
              width="24"
              height="24"
          ...
          <button
            ...
            className="flex items-center justify-center w-full max-w-[320px] gap-2 cursor-pointer px-6 py-3 bg-black rounded-xl text-white shadow-md hover:shadow hover:opacity-90 transition-all"
          >
            <svg
              width="24"
              height="24"
